 ...
 */
public class CartesianScaleOptions<S extends CartesianScaleOptions<S, T>, T extends CartesianTickOptions<?>>
	extends CoreScaleOptions<S, T>
{
	...
	public CartesianScaleOptions(final String type)
	{
		super(type);
	}
